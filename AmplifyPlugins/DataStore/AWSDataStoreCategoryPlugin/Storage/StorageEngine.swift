...
final class StorageEngine: StorageEngineBehavior {
    ...
    convenience init(isSyncEnabled: Bool, configuration: DataStoreConfiguration) throws {
        ...
        if #available(iOS 13.0, *) {
            ...
            self.init(storageAdapter: storageAdapter, configuration: configuration, syncEngine: syncEngine)
            ...
            self.init(storageAdapter: storageAdapter, configuration: configuration, syncEngine: nil)
        }
    }
